...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType {
    ...
    if (!self.isLoading) {
        if ([newUrl rangeOfString:@"weixin://wap/pay"].location != NSNotFound ||[newUrl rangeOfString:@"alipay://"].location != NSNotFound) {
            
            if([newUrl rangeOfString:@"alipay://"].location != NSNotFound){
                newUrl = [newUrl stringByRemovingPercentEncoding];
                if([newUrl containsString:@"alipays"]){
                    newUrl = [newUrl stringByReplacingOccurrencesOfString:@"alipays" withString:@"www.diyoupin.com"];
                    newUrl = [newUrl stringByURLEncoding];
                }
            }
