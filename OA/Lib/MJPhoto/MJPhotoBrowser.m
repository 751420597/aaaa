...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    //[[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(changeFrame:) name:@"deviceOrientationChange" object:nil];
}
-(void)viewWillDisappear:(BOOL)animated
{
    //[[NSNotificationCenter defaultCenter]removeObserver:self name:@"deviceOrientationChange" object:nil];
    [super viewWillDisappear:animated];
}

//-(void)changeFrame:(NSNotification*)note
//{
//   NSString *orientation=[note object];
//    if ([orientation intValue]==3||[orientation intValue]==4)//横屏
//    {
//        
//        if (IOS7_OR_LATER)
//        {
...
//            if (iPhone5)
//            {
//                self.view.frame=CGRectMake(0, 0, 548, 320);
//            }
//            else
//            {
//                self.view.frame=CGRectMake(0, 0, 460, 320);
//            }
//        }
////        CGAffineTransform transform= CGAffineTransformMakeRotation(M_PI*0.5);
////        _photoScrollView.transform=transform;
////        UIWindow* window=[UIApplication sharedApplication].keyWindow;
////        [window setFrame:self.view.frame];
//        
//    }
//    else if ([orientation intValue]==1)//竖屏
//    {
//        self.view.frame=[UIScreen mainScreen].bounds;
//        //[self performSelector:@selector(createUI) withObject:nil];
//        //[self show];
//    }
//}
...
//    if (self.target)
//    {
//        [((UINavigationController*)self.target).view addSubview:self.view];
//    }
    
//    UIStoryboard *board=[UIStoryboard storyboardWithName:@"Main" bundle:nil];
//    BaseNavigationVC* nav=[board instantiateViewControllerWithIdentifier:@"nav"];
//    [nav.view addSubview:self.view];
//    [nav.view bringSubviewToFront:self.view];
